...
@onready var _skin: Ranger = %Ranger
@onready var _anim_player: AnimationPlayer = %Ranger/AnimationPlayer
@onready var _anim_tree: AnimationTree = %Ranger/AnimationTree
