...
@onready var _skin: Rogue_Hooded = %Rogue_Hooded
@onready var _anim_player: AnimationPlayer = %Rogue_Hooded/AnimationPlayer
@onready var _anim_tree: AnimationTree = %Rogue_Hooded/AnimationTree
