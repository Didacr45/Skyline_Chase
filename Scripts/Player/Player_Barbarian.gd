...
@onready var _skin: Barbarian = %Barbarian
@onready var _anim_player: AnimationPlayer = %Barbarian/AnimationPlayer
@onready var _anim_tree: AnimationTree = %Barbarian/AnimationTree
